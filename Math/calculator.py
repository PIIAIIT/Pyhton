...
button_sub = Button(root, text="-", padx=20, pady=20, command=button_subtract)
button_mul = Button(root, text="*", padx=20, pady=20, command=button_multiply)
button_div = Button(root, text="/", padx=20, pady=20, command=button_divide)
button_eqaul = Button(root, text="Enter", padx=20, pady=20, command=button_eqaul)
...
button_eqaul.grid(row=4, column=3)
